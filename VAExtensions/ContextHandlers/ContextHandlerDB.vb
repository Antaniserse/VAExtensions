   ...
   Public Overrides Function Execute() As Boolean
      ...
      Select Case m_Context
         Case ContextFactory.Contexts.ReadDB
            ...
            Dim result As Data.DataTable = db.GetDataTable("select {0} from {1} where {2}", m_TextValues(App.KEY_DB_COLUMNS), m_TextValues(App.KEY_DB_TABLE), m_TextValues(App.KEY_DB_WHERE))
